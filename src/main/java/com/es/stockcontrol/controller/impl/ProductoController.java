...
public class ProductoController implements ProductoControllerAPI {
    ...
    @Override
    public RespuestaHTTP<Producto> altaProducto(String categoria,String nombreProducto, String descripcionProducto, String precioSinIva,String stock, String nombreProveedor) {
        try{
